...
class Updater : public QObject {
  ...
  signals:
    ...
    void downloadProgress(QString received, QString total);
    void timeProgress(QString time);
public:
    Updater();
    ~Updater();
    ...
    QString calculateTimeRemaining (qint64 received, qint64 total);
    void calculateSizes (qint64 received, qint64 total, QString& totalSize, QString& receivedSize);
